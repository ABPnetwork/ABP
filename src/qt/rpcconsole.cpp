                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzABPPathCustom = GetArg("-zabpbackuppath", "");
    ...
    if(!strzABPPathCustom.empty()) {
        ui->wallet_customzabpbackuppath->setText(QString::fromStdString(strzABPPathCustom));
        ui->wallet_customzabpbackuppath_label->setVisible(true);
        ui->wallet_customzabpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzABPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ABP RPC console.") + "<br>" +
