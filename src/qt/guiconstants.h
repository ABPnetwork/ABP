...
/* ABP GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ABP"
#define QAPP_ORG_DOMAIN "abp.org"
#define QAPP_APP_NAME_DEFAULT "ABP-Qt"
#define QAPP_APP_NAME_TESTNET "ABP-Qt-testnet"
