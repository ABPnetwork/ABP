...
#ifndef ABP_STAKEINPUT_H
#define ABP_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZABP() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zABPStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zabp, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZABP() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZABP() override { return false; }
};


#endif //ABP_STAKEINPUT_H
