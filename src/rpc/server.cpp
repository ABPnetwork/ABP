...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ABP features */
        {"abp", "masternode", &masternode, true, true, false},
        {"abp", "listmasternodes", &listmasternodes, true, true, false},
        {"abp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"abp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"abp", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"abp", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"abp", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"abp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"abp", "masternodedebug", &masternodedebug, true, true, false},
        {"abp", "startmasternode", &startmasternode, true, true, false},
        {"abp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"abp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"abp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"abp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"abp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"abp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"abp", "mnbudget", &mnbudget, true, true, false},
        {"abp", "preparebudget", &preparebudget, true, true, false},
        {"abp", "submitbudget", &submitbudget, true, true, false},
        {"abp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"abp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"abp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"abp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"abp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"abp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"abp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"abp", "checkbudgets", &checkbudgets, true, true, false},
        {"abp", "mnsync", &mnsync, true, true, false},
        {"abp", "spork", &spork, true, true, false},
        {"abp", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzabpseed", &getzabpseed, false, false, true},
        {"zerocoin", "setzabpseed", &setzabpseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzabp", &searchdzabp, false, false, true},
        {"zerocoin", "dzabpstate", &dzabpstate, false, false, true}
...
{
    return "> abp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5426/\n";
}
