...
extern UniValue setzabpseed(const UniValue& params, bool fHelp);
extern UniValue getzabpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzabp(const UniValue& params, bool fHelp);
extern UniValue dzabpstate(const UniValue& params, bool fHelp);
