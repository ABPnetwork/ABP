/* src/config/abp-config.h.  Generated from abp-config.h.in by configure.  */
/* src/config/abp-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.abp.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ABP Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ABP Core 3.1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "abp"
