...
In order to support loading of multiple wallets in abp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is abp.cpp.
...
Changes to abp.cpp
----------------------
abp.cpp is the entry point into abp-qt, and as such, will require some minor modifications to provide hooks for
