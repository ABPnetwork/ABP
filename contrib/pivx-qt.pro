...
RESOURCES += src/qt/abp.qrc src/qt/abp_locale.qrc

TRANSLATIONS += src/qt/locale/abp_bg.ts \
                src/qt/locale/abp_de.ts \
                src/qt/locale/abp_en.ts \
                src/qt/locale/abp_es.ts \
                src/qt/locale/abp_fi.ts \
                src/qt/locale/abp_fr.ts \
                src/qt/locale/abp_it.ts \
                src/qt/locale/abp_ja.ts \
                src/qt/locale/abp_pl.ts \
                src/qt/locale/abp_pt.ts \
                src/qt/locale/abp_ru.ts \
                src/qt/locale/abp_sk.ts \
                src/qt/locale/abp_sv.ts \
                src/qt/locale/abp_vi.ts \
                src/qt/locale/abp_zh_CN.ts \
                src/qt/locale/abp_zh_TW.ts
