...
This means one can have an always-on abpd instance running, and another local abpd/abp-qt instance which connects to this node and receives blocks from it.
