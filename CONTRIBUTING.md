Contributing to ABP Core
============================

The ABP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ABP Core project, and is not to be
confused with overall ABP Network Protocol consensus changes.

Whether a pull request is merged into ABP Core rests with the project merge
...
Patches that change ABP consensus rules are considerably more involved than
...
Where a patch set proposes to change the ABP consensus, it must have been
...
The project leader is the release manager for each ABP Core release.
